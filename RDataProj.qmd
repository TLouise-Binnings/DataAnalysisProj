...
ggsave("bar_2019malefemale.png", width = 14, height = 8, units = "in")
```
...
ggsave("bar_2023malefemale.png", width = 14, height = 8, units = "in")
```
```{r}

tbl2019_2023_stemfields_clean_prop <- bind_rows(tbl2019_stemfields_clean_prop, tbl2023_stemfields_clean_prop)
...
tbl2019_2023_stemfields_clean_prop |> 
  filter(!is.na(count)) |>
  ggplot(aes(x = fct_relevel(sex, c("Male", "Female")), y = prop, fill = fct_relevel(ethnicity_race, c("White", 
                                                 "Asian",
                                                 "Hispanic or Latino",
                                                 ...
                                                 "Other")))) +
  geom_col() +
  facet_grid(fct_relevel(field, c("Engineering",
                                    "Computer and Mathematical sciences", 
                                    "Physical and Related sciences", 
                                    "Social and Related sciences", 
                                    "Science & Engineering Related fields", 
                                    "Non-science & Engineering fields",
                                    "Biological, Agricultural, and Environmental Life sciences")) ~ year, 
             labeller = label_wrap_gen(width = 20), 
             scales = "fixed") +
  ylim(0,0.25) +
  scale_fill_viridis_d(direction = -1, end = 0.97) +
